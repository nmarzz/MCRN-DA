...
%% DMD Physical and POD for data Q=0.1 R=1e-2
a_0=load('SWEp_ 2 1_1.000000e-01_1.000000e-02_   1_2.mat');%inth=1
a_1=load('SWEp_ 2 1_1.000000e-01_1.000000e-02_  10_2.mat');%inth=10
a_2=load( 'SWEp_ 2 1_1.000000e-01_1.000000e-02_ 100_2.mat');%inth=100
a_3=load('SWEp_ 2 1_1.000000e-01_1.000000e-02_1000_2.mat');  %inth=1000
%%
% 'SWEp_ 1 1_1.000000e-02_1.000000e-02_   1_2_5.mat'
% 'SWEp_ 1 1_1.000000e-02_1.000000e-02_  10_2_5.mat'
%    'SWEp_ 1 1_1.000000e-02_1.000000e-02_ 100_2_5.mat'
% 'SWEp_ 2 2_1.000000e-01_1.000000e-02_ 100_2_5.mat'
%  'SWEp_ 2 2_ 1_1.000000e-02_   1_2_5.mat'
% 'SWEp_ 2 2_ 1_1.000000e-02_ 100_2_5.mat'
b_1=a_1.results;
c_1=a_1.params;
%%
b_2=a_2.results;
...
nexttile
plot(numModes,real(RMSEave_01),'Color', TOLC(9,:),'LineStyle','-.','LineWidth', 1.5)
grid on
hold on
