...
%% F=8, Q=1, R=1E-2, N=40
a_1=load('L968_ 1 1_1.000000_1.000000e-02_ 1_40.mat');%POD
a_2=load('L968_ 2 2_1.000000_1.000000e-02_ 1_40.mat'); %DMD
a_3=load('L968_ 3 3_1.000000_1.000000e-02_ 1_40.mat');%AUS
% %% F=8, Q=1e-1, R=1E-2, N=40
% a_1=load('L968_ 1 1_0.100000_1.000000e-02_ 1_40.mat');%POD
% a_2=load('L968_ 2 2_0.100000_1.000000e-02_ 1_40.mat'); %DMD
% a_3=load('L968_ 3 3_0.100000_1.000000e-02_ 1_40.mat');%AUS
% %% F=8, Q=1, R=1E-2, N=100
% a_1=load('L968_ 1 1_1.000000_1.000000e-02_ 1_100.mat');%POD
% a_2=load('L968_ 2 2_1.000000_1.000000e-02_ 1_100.mat'); %DMD
% a_3=load('L968_ 3 3_1.000000_1.000000e-02_ 1_100.mat');%AUS
% %% F=8, Q=1e-1, R=1E-2, N=100
% a_1=load('L968_ 1 1_0.100000_1.000000e-02_ 1_100.mat');%POD
% a_2=load('L968_ 2 2_0.100000_1.000000e-02_ 1_100.mat'); %DMD
% a_3=load('L968_ 3 3_0.100000_1.000000e-02_ 1_100.mat');%AUS
...
nexttile
% plot(numModes,real(RMSEave_proj_1),'Color', TOLC(9,:),'LineStyle','-.','LineWidth', 1.5)
% grid on
% hold on
...
% 
% legend('Identity Projection','POD','DMD','AUS','Observation Error',...
%     'FontWeight','normal',...
%     'FontSize',12,...
%     'FontName','Times',...
%     'Location','Best')
...
% nexttile([2 1])
 nexttile
% plot(numModes,real(XCave_proj_01),'Color', TOLC(9,:),'LineStyle','-.','LineWidth', 1.5)
% grid on
% hold on
...
%%
nexttile
% plot(numModes,RSpercent_01,'Color', TOLC(9,:),'LineStyle','-.','LineWidth', 1.5)
% grid on
% hold on
